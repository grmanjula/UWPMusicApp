#pragma checksum "C:\Users\admin\source\repos\UWPMusicApp\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "7D0104E860D2A6121FAA4E1FD5809F12"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace UWPMusicApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj6_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWPMusicApp.Model.MenuItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::UWPMusicApp.Model.MenuItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWPMusicApp.Model.MenuItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::UWPMusicApp.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::UWPMusicApp.Model.MusicCategory obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj12_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWPMusicApp.Model.Music dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 69 && columnNumber == 84)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::UWPMusicApp.Model.Music) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWPMusicApp.Model.Music)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::UWPMusicApp.Model.Music obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWPMusicApp.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 63 && columnNumber == 35)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWPMusicApp.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::UWPMusicApp.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_MenuItems(global::System.Collections.Generic.List<global::UWPMusicApp.Model.MenuItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Songs(global::System.Collections.ObjectModel.ObservableCollection<global::UWPMusicApp.Model.Music> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
